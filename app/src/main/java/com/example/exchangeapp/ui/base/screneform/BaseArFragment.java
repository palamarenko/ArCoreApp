...
public abstract class BaseArFragment extends Fragment
    ...
    private static final String TAG = com.google.ar.sceneform.ux.BaseArFragment.class.getSimpleName();
    ...
    public interface OnTapArPlaneListener {
         ...
         *
         * @see #setOnTapArPlaneListener(com.google.ar.sceneform.ux.BaseArFragment.OnTapArPlaneListener)
    ...
    @Nullable
    private com.google.ar.sceneform.ux.BaseArFragment.OnTapArPlaneListener onTapArPlaneListener;
     ...
     *
     * @param onTapArPlaneListener the {@link com.google.ar.sceneform.ux.BaseArFragment.OnTapArPlaneListener} to attach
     */
    public void setOnTapArPlaneListener(@Nullable com.google.ar.sceneform.ux.BaseArFragment.OnTapArPlaneListener onTapArPlaneListener) {
    ...
    public View onCreateView(
        ...
        frameLayout =
                (FrameLayout) inflater.inflate(com.google.ar.sceneform.ux.R.layout.sceneform_ux_fragment_layout, container, false);
        arSceneView = (ArSceneView) frameLayout.findViewById(com.google.ar.sceneform.ux.R.id.sceneform_ar_scene_view);
    ...
    protected void setupSelectionRenderable(FootprintSelectionVisualizer selectionVisualizer) {
        ModelRenderable.builder()
                .setSource(getActivity(), com.google.ar.sceneform.ux.R.raw.sceneform_footprint)
                .build()
                .thenAccept(
                        renderable -> {
    ...
    private void onSingleTap(MotionEvent motionEvent) {
        ...
        com.google.ar.sceneform.ux.BaseArFragment.OnTapArPlaneListener onTapArPlaneListener = this.onTapArPlaneListener;
